...
-keep class com.andre.luma_vid.data.models.** { *; }
-keep class com.andre.luma_vid.domain.entities.** { *; }

## Keep Flutter method channels and plugins
-keep class com.andre.luma_vid.MainActivity { *; }
...
## Keep BuildConfig
-keep class com.andre.luma_vid.BuildConfig { *; }
